   ...
   public synchronized void Start()
    ...
    {         
        ...
        { 
          ...
          InputStream audioSrc = getClass().getResourceAsStream("/Sounds/Intro.wav");
    ...
    public void setEffect(String url)
    {
        ...
        { 
          //URL defaultSound = this.getClass().getResourceAsStream("/Sound/deneme.wav"); 
          AudioInputStream audioInputStream1 = AudioSystem.getAudioInputStream(this.getClass().getResourceAsStream("/Sounds/" + url));
